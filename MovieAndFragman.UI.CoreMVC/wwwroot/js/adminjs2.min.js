function countUp(n){var r=100,u=Math.round(n/r),t=$(".count"),i=1,f=setInterval(function(){if(i<r)t.text(u*i),i++;else if(parseInt(t.text())<n){var e=parseInt(t.text())+1;t.text(e)}else clearInterval(f)},24)}function countUp2(n){var r=100,u=Math.round(n/r),t=$(".count2"),i=1,f=setInterval(function(){if(i<r)t.text(u*i),i++;else if(parseInt(t.text())<n){var e=parseInt(t.text())+1;t.text(e)}else clearInterval(f)},24)}function countUp3(n){var r=100,u=Math.round(n/r),t=$(".count3"),i=1,f=setInterval(function(){if(i<r)t.text(u*i),i++;else if(parseInt(t.text())<n){var e=parseInt(t.text())+1;t.text(e)}else clearInterval(f)},24)}function countUp4(n){var r=100,u=Math.round(n/r),t=$(".count4"),i=1,f=setInterval(function(){if(i<r)t.text(u*i),i++;else if(parseInt(t.text())<n){var e=parseInt(t.text())+1;t.text(e)}else clearInterval(f)},24)}function GetLastThirdMovie(){$.ajax({type:"get","async":!1,url:"../../../ajax/GetThird",success:function(n){$("#thirdMovie").html(n)}})}function GetFragmanListAll(){$.ajax({type:"get",url:"../../../ajax/GetAllFragman",success:function(n){$("#singleFragman").html(n)}})}function GetMovieByCId(n){$.ajax({type:"get",url:"../../../ajax/GetFragmansByCId?id="+n,success:function(n){$("#singleFragman").html(n)}})}function GetFragmanByName(n){n==""?GetFragmanListAll():$.ajax({type:"get",url:"../../../ajax/GetFragmansByName?name="+n,success:function(n){$("#singleFragman").html(n)}})}function GetRating(n){$.ajax({type:"GET",url:"../GetRating?id="+n,success:function(n){$("#rating").html(n)}})}function AddRating(n,t){$.ajax({type:"Get",url:"../../../ajax/AddRating?fid="+n+"&uid="+t,success:function(n){n.check||alertify.error(n.message)}})}function GetBtnMyList(n){$.ajax({type:"Get",url:n,success:function(n){$("#btnMyList").html(n);btnScript()}})}function btnScript(){$("#myList").click(function(){$("#myListItem").toggle()})}function DeleteFromList(n){$.ajax({type:"Get",url:"../../../mylist/Delete?id="+n,success:function(){GetBtnMyList("../../../mylist/getbtn");alertify.success("Film izlenecekler listesinden kaldırıldı.")}})}var Script=function(){$(".sparkline").each(function(){var n=$(this).data();n.valueSpots={"0:":n.spotColor};$(this).sparkline(n.data||"html",n,{tooltipFormat:'<span style="display:block; padding:0px 10px 12px 0px;"><span style="color: {{color}}">&#9679;<\/span> {{offset:names}} ({{percent.1}}%)<\/span>'})});$("#barchart").sparkline([5,3,6,7,5,6,4,2,3,4,6,8,9,10,8,6,5,7,6,5,4,7,4],{type:"bar",height:"65",barWidth:8,barSpacing:5,barColor:"#fff"});$("#linechart").sparkline([1,5,3,7,9,3,6,4,7,9,7,6,2],{type:"line",width:"300",height:"75",fillColor:"",lineColor:"#fff",lineWidth:2,spotColor:"#fff",minSpotColor:"#fff",maxSpotColor:"#fff",highlightSpotColor:"#fff",highlightLineColor:"#ffffff",spotRadius:4,highlightLineColor:"#ffffff"});$("#pie-chart").sparkline([2,1,1,1],{type:"pie",width:"100",height:"100",borderColor:"#00bf00",sliceColors:["#41CAC0","#A8D76F","#F8D347","#EF6F66"]});$("#work-progress1").sparkline([5,6,7,5,9,6,4],{type:"bar",height:"20",barWidth:5,barSpacing:2,barColor:"#5fbf00"});$("#work-progress2").sparkline([3,2,5,8,4,7,5],{type:"bar",height:"22",barWidth:5,barSpacing:2,barColor:"#58c9f1"});$("#work-progress3").sparkline([1,6,9,3,4,8,5],{type:"bar",height:"22",barWidth:5,barSpacing:2,barColor:"#8075c4"});$("#work-progress4").sparkline([9,4,9,6,7,4,3],{type:"bar",height:"22",barWidth:5,barSpacing:2,barColor:"#ff6c60"});$("#work-progress5").sparkline([6,8,5,7,6,8,3],{type:"bar",height:"22",barWidth:5,barSpacing:2,barColor:"#41cac0"});$("#pie-chart2").sparkline([2,1,1,1],{type:"pie",width:"250",height:"125",sliceColors:["#41CAC0","#A8D76F","#F8D347","#EF6F66"]})}(),Script=function(){$(".percentage").easyPieChart({animate:1e3,size:135,barColor:"#ff6c60"});$(".percentage-light").easyPieChart({barColor:function(n){return n/=100,"rgb("+Math.round(255*(1-n))+", "+Math.round(255*n)+", 0)"},trackColor:"#666",scaleColor:!1,lineCap:"butt",lineWidth:15,animate:1e3});$(".update-easy-pie-chart").click(function(){$(".easy-pie-chart .percentage").each(function(){var n=Math.floor(100*Math.random());$(this).data("easyPieChart").update(n);$("span",this).text(n)})});$(".updateEasyPieChart").on("click",function(n){n.preventDefault();$(".percentage, .percentage-light").each(function(){var n=Math.round(100*Math.random());$(this).data("easyPieChart").update(n);$("span",this).text(n)})})}();countUp(495);countUp2(947);countUp3(328);countUp4(10328);
